...
def banner():
          ...
          |        oMMMMMMMMMMMMMMMMMMMMMMMNMMMMMMMMMMMMMMMMMMMMMMMMMMo        |
          |      oMMo                HELLO MY FRİEND                 oMMo      |
          |    +MMMM                     WELCOME                      MMMM+    |
          ...
          |_  yMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMy  _|
          |M\  yMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMy  /M|
          |MM\ .yyMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMyy.   /MM|
          |MMMM\                        WELCOME TO                        /MMMM|
          |MMMMMM\                  MORBİUS FİNDER V4.0                 /MMMMMM|
          ...
          Github: {}
{}
""".format(GREEN,AUTHOR,INSTAGRAM,GİTHUB,END))
...
animasyon("{}{}[!] Morbius Admin Finder Version 4.0 İs Opening [!]".format(BOLD,GREEN))
time.sleep(3)
os.system('clear')
banner()
...
site = input('''
{}┌──({}root㉿m-finder{})-[{}menu{}]
└─{}# {}scan --site '''.format(BLUE,RED,BLUE,END,BLUE,RED,END))
...
hızlı_ani("""Scan site: {}{}{}""".format(UNDERLINE,site_inp,END))

time.sleep(1)

hızlı_ani("""
{}ERROR: Search type not specified!
{}If you want to perform a less comprehensive scan, type 1, {}if you want to perform a more comprehensive scan, type 2, {}if you want to search for subdomains, type 3 {}Specify the search type by typing the corresponding number.""".format(BOLD,CYAN,PURPLE,GREEN,END))

tip = (input("""
{}┌──({}root㉿m-finder{})-[{}menu{}]
└─{}# {}scan --site {} --scantype """.format(BLUE,RED,BLUE,END,BLUE,RED,END,site)))
...
hızlı_ani(""" 
Scan site: {}{}{}{}
Scan type: {}{}{}{}""". format (RED,UNDERLINE,site,END,RED,UNDERLINE,a,END))
time.sleep(1)

if tip == '1':
    uzantılar = ('admin','admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
 ...
 'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html',)
    for uzantı in uzantılar:
     ...
     try:
         ...
         print("\033[92m=====================================================")
         print("                                                             ")
         print("\033[92mADMİN PAGE BULDUM KANKİ:  "+curl                      )
         print("=====================================================")
     except urllib.error.URLError as msg:
         pass
     except KeyboardInterrupt:
         print('\nKolay gelsin\n Follow me on/nInstagram: @morbius.os/nGithub:{}'.format(GİTHUB))
         time.sleep(2)
         sys.exit()
         
elif tip == '2':
    linkler = open('.linkler2.txt', 'r',encoding='utf-8').read().split()
    for link in linkler:
        def heders():
            hd = agent.random()
            return hd
        ...
        try:
            url = ('http://'+site+'/'+link)
            get_req = req.get(url, timeout=1, headers=heders1)
            print("\033[92m=====================================================")
            print("                                                             ")
            print("\033[92mADMİN PAGE:  "+url                      )
            print("\033[92m=====================================================")
        except Exception:
            pass
        except KeyboardInterrupt:
         print('\nKolay gelsin\n Follow me on\nInstagram: @morbius.os\nGithub:{}'.format(GİTHUB))
         time.sleep(2)
         sys.exit()
